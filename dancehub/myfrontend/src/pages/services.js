                ...
                <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
                        <div className="w-full justify-center items-start gap-6 grid sm:grid-cols-2 grid-cols-1 lg:order-first order-last">
                            <div className="pt-24 lg:justify-center sm:justify-end justify-start items-start gap-2.5 flex">
                                <img className="rounded-lg" src={sample} alt="about Us image" />
                            </div>
                            <img className="h-99 rounded-lg" src={sample} alt="about Us image" />
                        </div>
            ...
            <div className="mx-auto mt-0 max-w-7xl lg:px-0 px-10 bg-white">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                    ...
                    <div className="flex flex-col justify-center mt-20">
                        ...
                        <div className="mb-4 text-base text-gray-500 font-normal text-black">
                        At Empire, we believe in the power of community and the magic of street dance. Every Sunday, we host street dance classes and battles on Wabera Street, providing a platform for local talent to shine. Our commitment to supporting street talent goes beyond the dance floor; it's about creating a vibrant community where everyone feels welcome and inspired. Come join us and be a part of something special – let's make Wabera Street the heartbeat of our dance community.  
                        </div>
                    </div>     
                </div>
            </div>
